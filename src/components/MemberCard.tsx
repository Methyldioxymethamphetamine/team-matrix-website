...
export default function MemberCard({
  ...
  return (
    <div className="member-card group relative rounded-2xl overflow-hidden bg-[#0a0a0f] border border-white/[0.08] transition-all duration-300 hover:border-red-500/40 hover:-translate-y-1 hover:shadow-[0_24px_48px_rgba(239,68,68,0.16)]">
      {/* Photo */}
      <div className="relative aspect-[4/5] overflow-hidden bg-[#111117]">
        ...
        <img
          ...
          alt={name}
          loading="lazy"
          className="w-full h-full object-cover object-top grayscale-[55%] contrast-[1.05] transition-all duration-500 ease-out group-hover:grayscale-0 group-hover:scale-[1.06]"
          onError={(e) => {
        ...
        {lead && (
          <div
            className="absolute top-3 left-3 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/55 border border-red-500/40 backdrop-blur-md"
